	...
	<div class = "pagina-consultas">
			...
			<div class = "contenedor-medio">
				...
				<div class = "formulario">
					<h1 class = "titulo">Dar de baja Alumno</h1>
						<form class = "formulario__elementos" action = "" method = "post" id = "formBaja">
...
"use strict"
	...
	document.getElementById("formBaja").onsubmit = function(){
		...
		if(matricula == ""){
			...
			var respuesta = confirm("¿Realmente desea dar de baja al alumno?");
				if(respuesta == true){
					return true;
				}else{
					return false;
