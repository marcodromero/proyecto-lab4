...
<body>
	<div class = "pagina-consultas">
			...
			<div class = "contenedor-medio">
				...
				<div class = "mensaje">
					<h1 class = "titulo">Dar de alta curso</h1>
					<p class = "mensaje__ok">¡Se ha dado de alta el curso con exito!</p>
					<a class = "boton-continuar" href = "nuevo-curso">Continuar</a>
				</div>
