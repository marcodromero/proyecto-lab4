...
<body>
	<div class = "pagina-consultas">
			...
			<div class = "contenedor-medio">
				...
				<div class = "mensaje">
					<h1 class = "titulo">Inscribir alumno en curso</h1>
					<p class = "mensaje__ok">¡Se inscribio al Alumno al curso con exito</p>
					<a class = "boton-continuar" href = "inscripcion">Continuar</a>
				</div>
