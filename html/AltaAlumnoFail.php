...
<body>
	<div class = "pagina-consultas">
			...
			<div class = "contenedor-medio">
				...
				<div class = "mensaje">
					<h1 class = "titulo">Dar alta Alumno</h1>
					<p class = "mensaje__fail">¡ERROR! No se pudo completar el registro. El DNI coincide con uno registrado previamente </p>
					<a class = "boton-continuar" href = "nuevo-alumno">Continuar</a>
				</div>
