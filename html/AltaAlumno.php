	...
	<body>
		<div class = "pagina-consultas">
			...
			<div class = "formulario">
				<h1 class = "titulo">Alta de Alumno</h1>
				<form class = "formulario__elementos" action = "" method = "post" id = "formAlta" >
					<input class = "formulario__entrada-texto" type="text" name = "alum_nombre" id = "alum_nombre" placeholder = "Nombre" required />
					<input class = "formulario__entrada-texto" type="text" name = "alum_apellido" id = "alum_apellido" placeholder = "Apellido" required />
		...
		"use strict"
			...
			document.getElementById("formAlta").onsubmit = function(){
				...
				var apellido = document.getElementById("alum_apellido").value;
